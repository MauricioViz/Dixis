...
public class FrmVistaProveedor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        GrillaProveedor.setEditingColumn(0);
        GrillaProveedor.setEditingRow(0);
        GrillaProveedor.setFocusable(false);
    ...
    private void GrillaProveedorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_GrillaProveedorMouseClicked
        if(opcion == 1)
        {
            if(evt.getClickCount() == 1)
            {
                ...
                FrmCompra.txtCodProvCompra.setText(GrillaProveedor.getValueAt(fila, 0).toString());
                FrmCompra.txtRazSocialProvCompra.setText(GrillaProveedor.getValueAt(fila, 1).toString());
                dispose();
            }
        }
        else if(opcion == 2)
        {
            ...
            {
                int fila = GrillaProveedor.getSelectedRow();
                FrmCompra.txtCodProvProd.setText(GrillaProveedor.getValueAt(fila, 0).toString());
                dispose();
            }
        }
